...
public class ProductController {
    ...
    public ResponseEntity<Product> updateProductByName(@PathVariable("name") String name, @PathVariable("id") Integer productId){
        return productService.update(name,productId)
                .map(products -> new ResponseEntity<>(products,HttpStatus.OK))
                .orElse(new ResponseEntity<>(HttpStatus.NOT_FOUND));
    }
